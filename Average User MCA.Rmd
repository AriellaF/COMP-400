...
dummies<-function(search.data, to.clean){
  ...
  print(typeof(search.data.clean[to.clean]))
  search.data.clean[to.clean]<-lapply(search.data.clean[to.clean],function(x) replace(x,is.na(x),"Empty"))
  # search.data.clean[to.clean]<-replace_na(search.data.clean[to.clean], "Empty")
  # var<-to.clean[1]
  ...
  # write.table(search.data.dummies, "before.csv", sep = ",", col.names = !file.exists("before.csv"), append = T)
  search.data.dummies<-search.data.dummies%>%
    unique()
  
  # write.table(search.data.dummies, "after.csv", sep = ",", col.names = !file.exists("after.csv"), append = T)
