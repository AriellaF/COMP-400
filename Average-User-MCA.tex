...
\NormalTok{data.clean.Diet.Yes<-}\KeywordTok{cleaner.S}\NormalTok{(cleaned.Diet.Yes)}
\NormalTok{search.MCA=}\KeywordTok{MCA}\NormalTok{(data.clean.Diet.Yes,}\DataTypeTok{graph=}\OtherTok{FALSE}\NormalTok{)}
\KeywordTok{fviz_screeplot}\NormalTok{(search.MCA,}\DataTypeTok{addlabels=}\NormalTok{T)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Average-User-MCA_files/figure-latex/diet yes all-1.pdf}
...
\includegraphics{Average-User-MCA_files/figure-latex/diet yes all-3.pdf}
...
\NormalTok{data.clean.Diet.No<-}\KeywordTok{cleaner.S}\NormalTok{(cleaned.Diet.No)}
\NormalTok{search.MCA=}\KeywordTok{MCA}\NormalTok{(data.clean.Diet.No,}\DataTypeTok{graph=}\OtherTok{FALSE}\NormalTok{)}
\KeywordTok{fviz_screeplot}\NormalTok{(search.MCA,}\DataTypeTok{addlabels=}\NormalTok{T)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Average-User-MCA_files/figure-latex/diet no all-1.pdf}
...
\NormalTok{data.cleaned.YA<-}\KeywordTok{cleaner.S}\NormalTok{(cleaned.YA)}
\NormalTok{search.MCA=}\KeywordTok{MCA}\NormalTok{(data.cleaned.YA,}\DataTypeTok{graph=}\OtherTok{FALSE}\NormalTok{)}
\KeywordTok{fviz_screeplot}\NormalTok{(search.MCA,}\DataTypeTok{addlabels=}\NormalTok{T)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Average-User-MCA_files/figure-latex/ya all-1.pdf}
...
\NormalTok{data.cleaned.Adult<-}\KeywordTok{cleaner.S}\NormalTok{(cleaned.adult)}
\NormalTok{search.MCA=}\KeywordTok{MCA}\NormalTok{(data.cleaned.Adult,}\DataTypeTok{graph=}\OtherTok{FALSE}\NormalTok{)}
\KeywordTok{fviz_screeplot}\NormalTok{(search.MCA,}\DataTypeTok{addlabels=}\NormalTok{T)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Average-User-MCA_files/figure-latex/adult all-1.pdf}
...
\includegraphics{Average-User-MCA_files/figure-latex/adult all-2.pdf}
...
\includegraphics{Average-User-MCA_files/figure-latex/adult all-3.pdf}
\#\#\# What Do Users Enjoy?
...
\NormalTok{data.cook.cleaned<-}\KeywordTok{cleaner.S}\NormalTok{(primary.cook)}
\NormalTok{search.MCA=}\KeywordTok{MCA}\NormalTok{(data.cook.cleaned,}\DataTypeTok{graph=}\OtherTok{FALSE}\NormalTok{)}
\KeywordTok{fviz_screeplot}\NormalTok{(search.MCA,}\DataTypeTok{addlabels=}\NormalTok{T)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Average-User-MCA_files/figure-latex/primary cook repsondent all-1.pdf}
...
\includegraphics{Average-User-MCA_files/figure-latex/primary cook repsondent all-2.pdf}
...
\includegraphics{Average-User-MCA_files/figure-latex/primary cook repsondent all-3.pdf}
...
\NormalTok{data.cleaned.cook.o<-}\KeywordTok{cleaner.S}\NormalTok{(primary.cook.o)}
\NormalTok{search.MCA=}\KeywordTok{MCA}\NormalTok{(data.cleaned.cook.o,}\DataTypeTok{graph=}\OtherTok{FALSE}\NormalTok{)}
\KeywordTok{fviz_screeplot}\NormalTok{(search.MCA,}\DataTypeTok{addlabels=}\NormalTok{T)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Average-User-MCA_files/figure-latex/primary cook other-1.pdf}
...
\includegraphics{Average-User-MCA_files/figure-latex/primary cook other-2.pdf}
...
\includegraphics{Average-User-MCA_files/figure-latex/primary cook other-3.pdf}
\#\#\# What Do Users Enjoy?
...
\NormalTok{cols<-}\KeywordTok{names}\NormalTok{(daily.cooks)}
\NormalTok{daily.cook.data<-}\KeywordTok{lapply}\NormalTok{(daily.cooks[cols], as.factor)}
\NormalTok{daily.cook.data<-}\KeywordTok{data.frame}\NormalTok{(daily.cook.data)}
\NormalTok{data.cook.cleaned<-}\KeywordTok{cleaner.S}\NormalTok{(daily.cook.data)}
\NormalTok{search.MCA=}\KeywordTok{MCA}\NormalTok{(data.cook.cleaned,}\DataTypeTok{graph=}\OtherTok{FALSE}\NormalTok{)}
\KeywordTok{fviz_screeplot}\NormalTok{(search.MCA,}\DataTypeTok{addlabels=}\NormalTok{T)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Average-User-MCA_files/figure-latex/daily cooks all-1.pdf}
...
\includegraphics{Average-User-MCA_files/figure-latex/daily cooks all-2.pdf}
...
\includegraphics{Average-User-MCA_files/figure-latex/daily cooks all-3.pdf}
...
\NormalTok{cols<-}\KeywordTok{names}\NormalTok{(weekly.cooks)}
\NormalTok{weekly.cook.data<-}\KeywordTok{lapply}\NormalTok{(weekly.cooks[cols], as.factor)}
\NormalTok{weekly.cook.data<-}\KeywordTok{data.frame}\NormalTok{(weekly.cook.data)}
\NormalTok{search.MCA=}\KeywordTok{MCA}\NormalTok{(weekly.cook.data,}\DataTypeTok{graph=}\OtherTok{FALSE}\NormalTok{)}
\KeywordTok{fviz_screeplot}\NormalTok{(search.MCA,}\DataTypeTok{addlabels=}\NormalTok{T)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Average-User-MCA_files/figure-latex/weekly/monlthly cooks all-1.pdf}
...
\includegraphics{Average-User-MCA_files/figure-latex/weekly/monlthly cooks all-2.pdf}
...
\includegraphics{Average-User-MCA_files/figure-latex/weekly/monlthly cooks all-3.pdf}
