...
Ingredients above vs ingredients pinned left while scrolling, reading discussion frequency, discussion frequency, save frequency, and useing review frequency have similar profiles and are well represented in both dimensions.
...
Save frequency, ingredients step by step vs pinned left while scrolling, useing reviews frequency, ingredients listed left vs. listed above, and ingredients step by step vs. listed above are associated with dimension 1.
...
Not enjoying Reddit for searching or browsing, discussion frequency, note taking potential, and note method satisfaction, and using digital recipes are well represented in dimension 2.
...
Using review frequency, save frequency, modification note frequency, ingredients above vs. pinned left while scrolling, and ingredients listed step by step vs. ingredients pinned left while scrolling are very well represented in dimension 1.

Not enjoying Reddit and video for searching or browsing, and trusting influencers' reviews are well represented in dimension 2.

Seeking review review frequency and discussion frequency is well represented in both dimension.

#### Variable Categories
Dimension 1 contrasts users cook weekly and do not enjoy online magazines for searching and browsing with users who enjoy blogs for searching and browsing.

Dimension 2 contrasts users enjoy blogs for searching and browsing, discuss recipes on Google, and have a low level of satisfaction with available note taking methods with users who enjoy discussion groups for recipes and enjoy discussing on Facebook.

```{r primary cook Respondent}
primary.cook.o<-filter(search.data, Meal.Prepper == "Respondent")
primary.cook.o<-primary.cook.o%>%select(-c(Meal.Prepper))
cleaned.data<-mca.plot(primary.cook.o)
```
...
Using review frequency and primary use of blogs are well represented in dimension one.

Not enjoying Reddit for searching or browsing, discussion frequency, and note taking potential are well represented in dimension 2.

Seeking review review frequency is well represented in both dimension.

#### Variable Categories

Dimension one contrasts users who never seek recipe reviews and never search for a recipe they have made before with users who always read recipe discussions and sometimes take note of recipe modifications.

Dimension two contrasts users who use, enjoy, and are influenced by Facebook with users who use end enjoy Instagram for searching and browsing.
...
Using the elbow rule, I will be looking at the first two components of this MCA analysis. Therefore this plot will only capture 32.7% of the variability in the data. More of the variance is captured in the components when we look at weekly cooks.

#### Variables

repeate search frequency, ingredients listed left vs. above, and ingredients step by step vs. pinned left while scrolling are well represented in dimension one.

No platform for modification notes and browsing while searching frequency are well represented in dimension 2.

Saving review frequency, modification frequency, seking review frequency and reading discussion frequencyare well represented in both dimensions

#### Variable Categories
The red point in the top right shows that unanswered questions have similar column profiles because it represents all the NA answers

Dimension one contrasts users who left NA answers or answered none with users who frequently interact with recipes.

Dimension two contrasts users who left blank answers with users who never seek reviews or save recipes
